...
Phase.setMatrix = function (matFunc) {
	Phase.Matrix = matFunc;
}
...
if (this.hasOwnProperty("WorkerGlobalScope")) {

	console.log("Add to global phase = {Phase, Solid, Liquid}")
	var phase = {
		Phase: Phase,
		Solid: Solid,
		Liquid: Liquid
	...
	console.log("export {Phase, Solid, Liquid}")
	Phase.Matrix = require(["../../jslib/matrix.mod.js"]);
